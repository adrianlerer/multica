...
These principles apply across all tasks. They bias toward caution, clarity, and minimum necessary change.
...
For multi-step tasks, state a brief plan with explicit verification steps. Strong success criteria let you loop independently — weak criteria ("make it work") require constant clarification.
